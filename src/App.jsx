...
import { FAQ_DATA, TESTIMONIALS_DATA, BLOGS_DATA, OFFERINGS_DATA, PRODUCT_DETAILS } from './data.js';
    ...
    try {
      const response = await fetch('/api/leads', {
        ...
        body: JSON.stringify({
          ...
          extraData: { city: formData.city, service: formData.service, slot: formData.slot }
        })
      });
      if (response.ok) {
        setIsSuccess(true);
